...
class Trans():
    ...
    def clean(self):
        ...
        for item in self.data:
            ...
            if not c.sameChecker(self.cur, trans_id):
                self.cleaned_data.append([trans_id, account_id, date, time, type, operation, amount, balance, k_symbol, bank])
    ...
    def output(self, fileName):
        ...
        csvwriter.writerow(['trans_id', 'account_id', 'date', 'time', 'type', 'operation', 'amount', 'balance', 'k_symbol', 'bank'])
